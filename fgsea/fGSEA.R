...
deg <- read_csv('BF591-Final/data/DESeq2_diffexpoutlier_trimmed_adjust.csv') %>% dplyr::rename(Gene='...1')
...
# fgsea
pathways_fgsea <- fgsea::gmtPathways('/usr4/bf527/jhlee18/R/final/BF591-Final/fgsea/c2.cp.v2023.1.Hs.symbols.gmt')
